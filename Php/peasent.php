...
<html>
    ...
    <body>
        <?php include '../Random/header.php' ?>
            <header><h1>Not an Admin mate!</h1></header>
            <main id="pageContent">
                <h1 class='return'>Return to site</h1>
                
                <div>
                    <img id='hacker' src="../Images/hacker.jpg" alt=""/>
                </div>
                
                <form method="get" action="../Php/why.php">
                    <button type="submit" class="sub">Leave this place !</button>
                </form>                
            </main>
